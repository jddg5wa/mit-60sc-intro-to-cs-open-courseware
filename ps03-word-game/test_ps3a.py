...
def test_deal_hand():
    ...
    if num != HAND_SIZE:
            ...
            print ("\tAsked for a hand of size" +  str(HAND_SIZE) + "but it returned a hand of size" + str(num))
    ...
    if repeats > 10:
        print ("FAILURE: test_deal_hand()")
        print ("\tSame hand returned" + str(repeats) + "times by deal_hand(). This is HIGHLY unlikely.")
...
def test_get_word_score():
    ...
    for (word, n) in words.keys():
        ...
        if score != words[(word, n)]:
            ...
            print ("\tExpected" + str(words[(word, n)]) + "points but got '" + str(score) + "' for word '" + str(word) + "', n=" + str(n))
            failure=True
    if not failure:
...
def test_update_hand():
    ...
    if hand2 != expected_hand1 and hand2 != expected_hand2:
        ...
        print ("\tReturned: " + str(hand2) + "-- but expected:" + str(expected_hand1) + "or" + str(expected_hand2))
...
def test_is_valid_word(word_list):
    ...
    if not is_valid_word(word, hand, word_list):
        ...
        print ("\tExpected True, but got False for word: '" + str(word) + "' and hand:" + str(hand))
    ...
    if  is_valid_word(word, hand, word_list):
        print ("FAILURE: test_is_valid_word()")
        print ("\tExpected False, but got True for word: '" + str(word) + "' and hand:" + str(hand))
